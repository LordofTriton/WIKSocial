        ...
        >
            <div className="flex flex-col flex-1 justify-center items-center">
                ...
                <div className="w-3/4 mt-6">
                    ...
                    <div className="bg-whitesmoke dark:bg-ash text-black dark:text-gray-300 flex flex-row justify-center items-center rounded-xl px-5 py-3 mb-3 cursor-pointer hover:bg-gray-200 dark:hover:bg-night" onClick={() => toggleModal("login.mail")}>
                ...
                <span className="text-base text-black dark:text-gray-300 font-semibold mt-4">
                    ...
                    <span className="text-md text-tang-blue cursor-pointer font-semibold" onClick={() => toggleModal("signup")}> Sign Up!</span>
                </span>

                
                <span className="text-xs text-tang-blue mt-4" onClick={() => router.push("/support#login")}>How do I log in via FB, Apple, or X?</span>
            </div>
        </Modal>
    );
};